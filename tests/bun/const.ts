...
export const PRISME_OUTBOUND_LINK_CLICK_EVENTS_URL = PRISME_API_URL + '/events/clicks/outbound-link'
export const PRISME_FILE_DOWNLOAD_CLICK_EVENTS_URL = PRISME_API_URL + '/events/clicks/file-download'
