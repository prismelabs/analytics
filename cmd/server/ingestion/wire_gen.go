...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	getNoscriptEventsOutboundLink := handlers.ProvideGetNoscriptEventsOutboundLink(eventstoreService, sessionstorageService, saltmanagerService)
	...
	postEventsFileDownload := handlers.ProvidePostEventsFileDownload(eventstoreService, saltmanagerService, sessionstorageService)
	postEventsOutboundLink := handlers.ProvidePostEventsOutboundLink(eventstoreService, saltmanagerService, sessionstorageService)
	...
	app := wired.ProvideFiber(apiEventsTimeout, eventsCors, eventsRateLimiter, getNoscriptEventsCustom, getNoscriptEventsOutboundLink, getNoscriptEventsPageviews, minimalFiber, nonRegisteredOriginFilter, noscriptHandlersCache, postEventsCustom, postEventsFileDownload, postEventsOutboundLink, postEventsPageviews, referrerAsDefaultOrigin)
