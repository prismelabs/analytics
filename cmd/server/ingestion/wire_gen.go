...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	postEventsClicks := handlers.ProvidePostEventsClicks(eventstoreService, saltmanagerService, sessionstorageService)
	...
	app := ProvideFiber(apiEventsTimeout, eventsCors, eventsRateLimiter, getNoscriptEventsCustom, getNoscriptEventsPageviews, minimalFiber, nonRegisteredOriginFilter, noscriptHandlersCache, postEventsClicks, postEventsCustom, postEventsPageviews)
