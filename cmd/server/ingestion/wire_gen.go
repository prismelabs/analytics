...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	getNoscriptEventsPageview := handlers.ProvideGetNoscriptEventsPageview(zerologLogger, eventstoreService, uaparserService, ipgeolocatorService, saltmanagerService, sessionstorageService)
	...
	app := ProvideFiber(eventsCors, eventsRateLimiter, minimalFiber, nonRegisteredOriginFilter, getNoscriptEventsPageview, postEventsCustom, postEventsIdentify, postEventsPageview)
