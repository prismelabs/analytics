...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	app := wired.ProvideFiber(apiEventsTimeout, eventsCors, eventsRateLimiter, getNoscriptEventsCustom, getNoscriptEventsPageviews, minimalFiber, nonRegisteredOriginFilter, noscriptHandlersCache, postEventsCustom, postEventsFileDownload, postEventsOutboundLink, postEventsPageviews)
