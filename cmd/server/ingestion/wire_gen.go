...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	app := ProvideFiber(eventsCors, eventsRateLimiter, minimalFiber, nonRegisteredOriginFilter, noscriptHandlersCache, getNoscriptEventsCustom, getNoscriptEventsPageviews, postEventsCustom, postEventsIdentify, postEventsPageview)
