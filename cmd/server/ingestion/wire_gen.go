...
func Initialize(logger wired.BootstrapLogger) wired.App {
	...
	app := ProvideFiber(apiEventsTimeout, eventsCors, eventsRateLimiter, getNoscriptEventsCustom, getNoscriptEventsPageviews, minimalFiber, nonRegisteredOriginFilter, noscriptHandlersCache, postEventsCustom, postEventsIdentify, postEventsPageview)
