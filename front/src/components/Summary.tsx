...
export default function Summary() {
  ...
  useEffect(() => {
    ...
    fetch(
      `${prismeUrl}/api/v1/stats/batch?metrics=visitors,sessions,pageviews,live-visitors,bounces&from=now-1h&to=now`,
      {
        signal: abort.signal,
      },
    )
  ...
  const metrics = [
    ...
    },
    {
      ...
      value: sum(pageViewsDF.values).toString(),
      data: visitorsDF,
    },
    {
    ...
    { name: "Live visitors", value: liveVisitors.toString(), data: visitorsDF },
    {
      name: "Bounce rate",
