...
func ConfigueLoadFunc(t require.TestingT, setup func(figue *configue.Figue)) {
	figue := configue.New(
		"",
...
func ConfigueLoad(t require.TestingT, objects ...interface{ RegisterOptions(*configue.Figue) }) {
